...
jsフォルダ内のtemplatesフォルダ以下にあるテンプレートを、
プラグインフォルダの「js」フォルダ以下か、テーマフォルダの「js」フォルダ以下に「プラグインフォルダ名」のフォルダを作成してそこにコピーしてリネームし、
JavaScript内のname, page, adminbarなどの値を編集してください。

■■■■■■■■■■■
カスタムしたJavaScriptは別途バックアップを必ずとってください。
現状ではプラグインアップデートによって、カスタムしたJavaScriptファイルが消えてしまいます！！！
■■■■■■■■■■■

カスタムしたJavaScriptがおける場所
